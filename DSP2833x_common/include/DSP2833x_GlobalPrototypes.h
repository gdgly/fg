...
extern void InitEPwmSyncGpio(void);					// 修改，加入声明，防止lint出错
...
extern void InitMcbspGpio(void);					// 修改，加入声明，防止lint出错
...
extern void EnableDog(void);		// 修改 增加一个使能看门狗函数
