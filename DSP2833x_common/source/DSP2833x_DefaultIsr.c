...
#include "..\..\EnergyStg\code\base_except.h"

Uint32 isr_n_dump = 0;			// ÐÞ¸Ä
//---------------------------------------------------------------------------
...
{
  //asm ("      ESTOP0");
 EXCEPT_JUDGE_SET((isr_n_dump>5), 2012);	isr_n_dump++;
}
