...
static void delay_loop(void);		// Delay function used for SRG initialization
static void clkg_delay_loop(void); // Delay function used for CLKG initialization
...
static void clkg_delay_loop(void)
{
    long      i;
